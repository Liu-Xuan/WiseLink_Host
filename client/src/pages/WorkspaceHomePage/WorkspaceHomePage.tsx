...
function relationRoleLabel(role: CanonicalRelatedDocumentRelation['relationRole']): string {
              ...
              <>
                <div className="library-preview-title">
                  ...
                  <div>
                    ...
                    <p>
                      {projection.classification.normalizedFamily} · 当前受控版本
                    </p>
                  </div>
