...
export interface SuiteMatterGraphViewProps {
  ...
  timelineSources?: EngineeringMatterCatalogEntry[];
  onOpenTimelineSource?: (source: EngineeringMatterCatalogEntry) => void;
