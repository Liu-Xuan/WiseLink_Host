  ...
  if (!result) {
    ...
    if (!execution) {
      try {
        ...
        if (!['JOBAID_INCOMPLETE_TERMINAL_RESPONSE', 'JOBAID_MODEL_OUTPUT_LENGTH', 'JOBAID_WORK_VALIDATION_FAILED', 'JOBAID_WORK_JSON_INVALID'].includes(failure?.errorCode)) throw error;
