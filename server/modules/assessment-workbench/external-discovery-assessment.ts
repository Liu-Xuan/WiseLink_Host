...
import { normalizeHostedOpenClawDiscoveryResult } from './hosted-openclaw-discovery-normalizer';
...
export function prepareExternalDiscoveryCandidateDraftForAily(
  ...
  const normalized = normalizeHostedOpenClawDiscoveryResult(external);
