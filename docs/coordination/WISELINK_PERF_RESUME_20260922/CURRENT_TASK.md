...
B系统性能工作树：`/private/tmp/wiselink-perf-b-graph-return-20260923`，分支`codex/perf-b-graph-return-20260923`；起点`b2247dee71a415636232d85f31c846948d296353`。当前2C.4a导航/视角切换前读取最新相机并立即保存导航历史。独立源码/测试由B提交、Luna验收、主控选择性集成。本树不是最终集成/线上版本。
...
| 2C | 3e0cc6074按帧合并/状态去重/销毁清理，Luna5套52项及构建通过。2C.2 bcccd815正文memo/稳定回调已获Luna 5套53项验收。2C.3 b2247dee7增量拓扑、标题刷新不重排/不丢拖动位置，6套57项通过待Luna；当前2C.4a在导航和切换视角前捕获最新相机，导航前立即替换当前历史项，修复RAF/320ms延迟导致旧镜头。跨页拖动布局恢复、通用退出及真实交互计量仍需继续。 |
...
3A.2真实SQL/RLS、3A.3和2C.2独立验收已完成；2C.3已交验收，2C.4a定向相机返回完成后继续2C剩余布局/生命周期与2B.2复用测量，不忽略2B.2/2C/2D/3B。完整计划见OFFICIAL_CODEX_ROADMAP。Goal仅在全部要求证据齐备时关闭，不在子批交付时关闭。
