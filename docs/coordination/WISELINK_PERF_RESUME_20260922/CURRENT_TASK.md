...
B系统性能工作树：`/private/tmp/wiselink-perf-b-semantic-order-20260923`，分支`codex/perf-b-semantic-order-20260923`；起点`81ea079eacf8b41c35bd82ad4493cef61705a86a`。当前3A.3语义准备与翻译启动排序。独立源码/测试变更由B提交、Luna验收、主控选择性集成。不要把本树当最终集成/线上版本。
...
| 3A.2/3 | 81ea079ea已改pending优先、空闲窄查精确语义登记，Luna本地4套25项验收通过，仍需真实SQL/RLS。3A.3已按主控授权单写者修订consumer：新START需当前语义就绪，历史pending不替代；已就绪不等待索引，索引失败鲜活回读就绪，旧任务状态/恢复不阻断。98项Node及3套16项Jest通过，待独立验收。 |
