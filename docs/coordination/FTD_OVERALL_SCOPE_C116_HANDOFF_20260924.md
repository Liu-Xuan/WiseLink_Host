...
适用性、Review、事项、文档或正式采用的授权。主控在 c115 Host 发布完成当时
读回 release `7688907528675527897` 的 SHA 为
`43c4e33a3a97a38c36c18681cc1013ba81a006f0`。2026-09-24 再查该旧 ID
显示 `def68384f5deef7f0976e31138b10a3464b63ee8`；主控已用旧 3db、43c4、
最新 def683 三个 release ID 复核到相同当前 commit，说明 `release-get.commit_id`
是当前应用投影，不能据旧 ID 的后续回显改写历史发布记录。最新 def683 的发布
ID 为 `7688909015430564820`。这些云端提交当前均不在本机 Git；集成时仍须核对
实际源码、准确差异与父提交，不能仅凭本地测试视为部署。
