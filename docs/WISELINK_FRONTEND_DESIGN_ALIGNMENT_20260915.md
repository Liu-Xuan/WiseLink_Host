...
当前产品发布提交为 `218de67b335f221ba146d29563f31fc3da404e24`，包含 F1 三批阅读、复核身份恢复入口及实际保存摘要修复；官方 release `7685792528452390154` 已完成。真实阅读验收见 [M 集成记录](coordination/M_INTEGRATION.md)。附件所述旧分支、解析等待、旧工作号及历史类型错误不替代此接受点，也不要求重做已验收导航。
