...
当前产品发布提交为 `735dbdf40737b9f1f0cead53dd69745cd0e50761`，包含 F1 三批阅读实现；官方 release `7685779738674269395` 已完成。真实阅读验收见 [M 集成记录](coordination/M_INTEGRATION.md)。附件所述旧分支、解析等待、旧工作号及历史类型错误不替代此接受点，也不要求重做已验收导航。
