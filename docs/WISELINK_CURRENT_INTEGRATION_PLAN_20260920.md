...
- 当前文档 HEAD 为 `codex/0-11` 的 `25c34281a0cf07e064c84870e447407384e66857`，父提交 `2c6691ea5908edec4aeb62b940be2789bf4ceba8`；`origin/codex/0-11` 与 `github/codex/0-11` 已分别回读相同 SHA。`1031e3caa` 仍是最近已接受的生产 Reader/换版代码恢复点，它把正式入口迁回真实授权读取链，并把 Suite 构造页限制在 `dev-preview`。之后已选择性提交 Reader 1A、图谱读取清理、筛选可访问性、图谱确切原文路径和 Reader 来源定位优先级修复。祖先链还包含针对 `9419d320c` 已知身份回归的纠正 `8d186d5b2`、知识读取修复 `957f327cd` 和资料库真实默认选择 `d7b074447`。
