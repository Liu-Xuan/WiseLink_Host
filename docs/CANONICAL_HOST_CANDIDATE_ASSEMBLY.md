# Canonical Host 架构与装配边界（2026-08-15 历史）

更新时间：2026-08-15

本文件保留当时装配记录，不再作为当前架构指令。其中 Aily 单一只读 MCP、OpenClaw 仅负责发现、无租约等表述已不代表当前实现。当前设计与状态见 [R10 系统盘点](WISELINK_R10_SYSTEM_REVIEW_20260905.md) 和现行 R10 云文档。
